...
class AdminController extends Controller
{
  public function indexAction() {
    ...
    $user_per_gender = $userStatsService->getUserPerGender($users);
    ...
    return $this->render('DogeFacebookBundle:Admin:index.html.twig', [  'users' => $users, 'json' => $json, 'countries' => $countries, 'user_per_country' => $user_per_country,
                                                                        'nb_user_age_below_25' => $nb_user_age_below_25, 'nb_user_age_over_25' => $nb_user_age_over_25, 'user_per_gender' => $user_per_gender]);
